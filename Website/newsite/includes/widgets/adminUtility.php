	...
	<div class="content">
		<div class="uploadForm"><!-- utilities that show up for all admin accounts-->
            ...
            <h3>Change User Password</h3>
                <form action="adminchangepassword.php" method="POST"><select id="select_user" name="select_user" ><?php echo company_user_list()?></select> <input type="text" name="newPassword" placeholder="New Password (7+ Length)" id="normalinput">
