...
if (isset($_GET['username']) === true && empty($_GET['username']) === false) {
	...
	if (user_exists($username) === true) {
		...
		$_POST['current_company']=company_name_from_company_id($profile_data['company'])
?>
		
	<h1><?php echo company_from_username($username)?> </h1>
	 ...
	 <p>
	    <a href="http://archive.constantcontact.com/fs051/1102751453546/archive/1102816085897.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','media/constant_contact_logo.png',1)"><img src="media/constant_contact_logo1.png" width="200"  img style="border-style: none;" id="Image1" /></a>
		<?php if(is_admin($profile_user_id) or is_subadmin($profile_user_id)){ 
			echo "<a href='mail.php' onmouseout='MM_swapImgRestore()' onmouseover='MM_swapImage('Image3','','media/send_mail1.png',1)'><img src='media/send_mail.png' width='110' img style='border-style: none;' id='Image3' /></a>";
			}?>	
	</p>
		</td>
		<td>
       	<?php if(is_admin($profile_user_id)){
			...
			include 'includes/widgets/adminContacts.php';
		}elseif(is_subadmin($profile_user_id)){
			include 'includes/widgets/uploader.php'; 
			include 'includes/widgets/subAdminUtility.php';
			include 'includes/widgets/adminContacts.php';
		}else{
			include 'includes/widgets/userUtility.php';
		}
