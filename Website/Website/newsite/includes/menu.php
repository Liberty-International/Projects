                    ...
                    <div class="dd-col1">
                       <ul>
                          ...
                          <li><a href="customsclearance.php" 
							onmouseover="changetext('service_change','Liberty views the entry process as a strategic advantage, constantly driving toward an average clearance time of zero days');"
                ...
                <div class="tier1">
                    ...
                    <div class="dd-col2">
						<ul>
                          	...
                          	In 1982, Nick, Chuck & Ken wanted to create a place where hard working young people would have an opportunity to grow and advance.  Click \'About Us\'ù to read Liberty's story.
                          	</div>
                        </ul>
                    </div>
                </div>
...
<!--MEMBERS DROPDOWN MENU-->
     <li class="top-menu left-aligned-dd">
		<?php  //if logged in
			$thisdir = getcwd(); 
        if (logged_in() === true) {?>
			  <a href=profile.php?username=<?php echo $user_data['username']; ?> class="top-menu"><span><?php echo company_from_username($user_data['username']); ?><span></a>
